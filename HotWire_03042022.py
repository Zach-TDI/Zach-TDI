...
from PyQt5.QtWidgets import QWidget, QMessageBox, QListWidget, QListWidgetItem, QLabel, QApplication, QDialog
import socket
...
class Ui_HotWire(object):
    ...
    def setupUi(self, HotWire, X_Size, Y_Size, Xpos1, Xpos2, Xpos3, Ypos1, Ypos2, Ypos3):
        ...
        icon.addPixmap(QtGui.QPixmap(
            "C:/Users/zachc/OneDrive/Documents/FluxLogs/Tests/Symbol-Recycle.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)

        self.Reset.setIcon(icon)
        self.Reset.setIconSize(QtCore.QSize(100, 100))
...
##################################################################
    ...
    def show_popup(self, btn):
        msgbox = QMessageBox()
        msgbox.setWindowTitle("Wait for complete")
        msgbox.setText("Wainting for movement to " +
                       btn + " To Complete")
        x = msgbox.exec_()
